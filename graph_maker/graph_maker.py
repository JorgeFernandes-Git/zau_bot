...
if __name__ == "__main__":
    ...
    g = create_node(g, black, 'manipulator_links', 'manipulator_links')
    ...
    g = create_edge(g,'base_link','manipulator_links','dynamic',black)
    g = create_edge(g,'manipulator_links','ee_link','dynamic',black)
